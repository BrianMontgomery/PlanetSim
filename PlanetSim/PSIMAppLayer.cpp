...
void PSIMAppLayer::OnUpdate(Timestep ts)
{
	...
	std::cout << m_CameraController.GetCamera().getViewMatrix()[0].x << ", " << m_CameraController.GetCamera().getViewMatrix()[1].x << m_CameraController.GetCamera().getViewMatrix()[2].x <<
		m_CameraController.GetCamera().getViewMatrix()[3].x << m_CameraController.GetCamera().getViewMatrix()[0].y << ", " << m_CameraController.GetCamera().getViewMatrix()[1].y << m_CameraController.GetCamera().getViewMatrix()[2].y <<
		m_CameraController.GetCamera().getViewMatrix()[3].y << m_CameraController.GetCamera().getViewMatrix()[0].z << ", " << m_CameraController.GetCamera().getViewMatrix()[1].z << m_CameraController.GetCamera().getViewMatrix()[2].z <<
		m_CameraController.GetCamera().getViewMatrix()[3].z << m_CameraController.GetCamera().getViewMatrix()[0].w << ", " << m_CameraController.GetCamera().getViewMatrix()[1].w << m_CameraController.GetCamera().getViewMatrix()[2].w <<
		m_CameraController.GetCamera().getViewMatrix()[3].w << std::endl;
